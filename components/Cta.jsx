...
const Cta = () => (
  <section className="sm:my-16 my-10 sm:py-10 py-10 bg-black-gradient rounded-3xl flex flex-col justify-center items-center sm:flex-row flex-wrap sm:justify-around ">
    <div className="pb-10">
